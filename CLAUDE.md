...
- **Exception — components whose layout/spacing can't reasonably be left to every consumer** (currently `ValuesCloud` and `SectionHeading`) may ship real, structural CSS via the `./css` export subpath:
